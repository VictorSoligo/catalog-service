...
- Whenever there is a change in the product catalog, publish this change to the "catalog-emit" topic in the queue.
...
- Any database.
- A queue for the catalog change notifications.
